...
urlpatterns = [
    ...
    path('transport/', views.TransportList.as_view(), name='transport_list'),
    ...
    path('presenter/', views.PresenterList.as_view(), name='presenter_list'),
    path('presenter/<slug:slug>', views.PresenterDetail.as_view(), name='presenter_detail'),
    path('registry-office/', views.RegistryOfficeList.as_view(), name='registryoffice_list'),
    ...
    path('bouquet/', views.BouquetList.as_view(), name='bouquet_list'),
    ...
    path('stylist/', views.StylistList.as_view(), name='stylist_list'),
    path('stylist/<slug:slug>', views.StylistDetail.as_view(), name='stylist_detail'),
    path('photo-studio/', views.PhotoStudioList.as_view(), name='photostudio_list'),
    ...
    path('agency/', views.AgencyList.as_view(), name='agency_list'),
