...
class Agency(models.Model):
    ...
    address_uz = models.CharField('Адрес UZ', max_length=155, blank=True)
    ...
    phone2 = models.CharField('Телефон №2', max_length=13, null=True, blank=True)
    phone3 = models.CharField('Телефон №3', max_length=13, null=True, blank=True)
...
class PhotoStudio(models.Model):
    ...
    slug = models.SlugField(max_length=200, unique=True)
    location = models.ForeignKey('account.District', on_delete=models.CASCADE, verbose_name='Местоположение', null=True)
    additional_services = models.ManyToManyField('PhotostudioAdditionalFeeService', verbose_name='Услуги за доп плату', blank=True)
    benefits = models.ManyToManyField('PhotostudioBenefits', verbose_name='Преимущества', blank=True)
    payment = models.ManyToManyField('PhotostudioPaymentMethod', verbose_name='Способы оплаты', blank=True)
    telegram = models.CharField(max_length=155, blank=True)
    instagram = models.CharField(max_length=155, blank=True)
    facebook = models.CharField(max_length=155, blank=True)
    is_pro = models.BooleanField(default=False)
...
class Presenter(models.Model):
    ...
    phone2 = models.CharField('Телефон №2', max_length=13, null=True, blank=True)
    phone3 = models.CharField('Телефон №3', max_length=13, null=True, blank=True)
    additional_services = models.ManyToManyField('PresenterAdditionalFeeService', verbose_name='Услуги за доп плату', blank=True)
    benefits = models.ManyToManyField('PresenterBenefits', verbose_name='Преимущества', blank=True)
    payment = models.ManyToManyField('PresenterPaymentMethod', verbose_name='Способы оплаты', blank=True)
    telegram = models.CharField(max_length=155, blank=True)
    instagram = models.CharField(max_length=155, blank=True)
    facebook = models.CharField(max_length=155, blank=True)
    slug = models.SlugField(max_length=200, unique=True)
...
class Music(models.Model):
    ...
    additional_services = models.ManyToManyField('MusicAdditionalFeeService', verbose_name='Услуги за доп плату', blank=True)
    benefits = models.ManyToManyField('MusicBenefits', verbose_name='Преимущества', blank=True)
    payment = models.ManyToManyField('MusicPaymentMethod', verbose_name='Способы оплаты', blank=True)
    phone = models.CharField('Телефон', max_length=13)
    phone2 = models.CharField('Телефон №2', max_length=13, null=True, blank=True)
    phone3 = models.CharField('Телефон №3', max_length=13, null=True, blank=True)
    telegram = models.CharField(max_length=155, blank=True)
...
class Restaurant(models.Model):
    ...
    additional_services = models.ManyToManyField('RestaurantAdditionalFeeService', verbose_name='Услуги за доп плату', blank=True)
    benefits = models.ManyToManyField('RestaurantBenefits', verbose_name='Преимущества', blank=True)
    payment = models.ManyToManyField('RestaurantPaymentMethod', verbose_name='Способы оплаты', blank=True)
    telegram = models.CharField(max_length=155, blank=True)
    instagram = models.CharField(max_length=155, blank=True)
    facebook = models.CharField(max_length=155, blank=True)
    location = models.ForeignKey('account.District', on_delete=models.CASCADE, verbose_name='Местоположение', null=True)
...
class Photographer(models.Model):
    ...
    additional_services = models.ManyToManyField('PhotographerAdditionalFeeService', verbose_name='Услуги за доп плату', blank=True)
    benefits = models.ManyToManyField('PhotographerBenefits', verbose_name='Преимущества', blank=True)
    payment = models.ManyToManyField('PhotographerPaymentMethod', verbose_name='Способы оплаты', blank=True)
    phone = models.CharField('Телефон', max_length=13)
    phone2 = models.CharField('Телефон №2', max_length=13, null=True, blank=True)
    phone3 = models.CharField('Телефон №3', max_length=13, null=True, blank=True)
...
class Videographer(models.Model):
    ...
    additional_services = models.ManyToManyField('VideographerAdditionalFeeService', verbose_name='Услуги за доп плату', blank=True)
    benefits = models.ManyToManyField('VideographerBenefits', verbose_name='Преимущества', blank=True)
    payment = models.ManyToManyField('VideographerPaymentMethod', verbose_name='Способы оплаты', blank=True)
    phone = models.CharField('Телефон', max_length=13)
    phone2 = models.CharField('Телефон №2', max_length=13, null=True, blank=True)
    phone3 = models.CharField('Телефон №3', max_length=13, null=True, blank=True)
    telegram = models.CharField('Телеграм', max_length=50)
